...
#define RAYGUI_PANEL_BORDER_WIDTH 1
    ...
    GuiDrawRectangle(bounds, RAYGUI_PANEL_BORDER_WIDTH, (Color){243, 243, 243, 255},
                     (Color){58, 71, 80, 255});
    //--------------------------------------------------------------------
...
int GuiStatusBar(Rectangle bounds, const char *text)
{
    ...
    // Draw control
    //--------------------------------------------------------------------
    GuiDrawRectangle(bounds, GuiGetStyle(STATUSBAR, BORDER_WIDTH), GetColor(GuiGetStyle(STATUSBAR, BORDER + (state * 3))), (Color){58, 71, 80, 255});
...
static void GuiDrawRectangle(Rectangle rec, int borderWidth, Color borderColor, Color color)
{
    if (color.a > 0)
    {
        ...
        DrawRectangleRounded(rec, 0.3, 0, GuiFade(color, guiAlpha));
    }
    ...
    if (borderWidth > 0)
    {
        ...
        DrawRectangleRoundedLines(rec, 0.3, 0, GuiFade(borderColor, guiAlpha));
    }

#if defined(RAYGUI_DEBUG_RECS_BOUNDS)
    DrawRectangle(rec, 0.3, 0, Fade(RED, 0.4f));
#endif
}
